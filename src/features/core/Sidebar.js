                            ...
                            <ul role="list" className="-mx-2 abv">
                                <li className="">
                                    <a href="#" className={sidebarLink == "llmNews" ? activeClass : nonActiveClass}>
                                        <span className="border-color-theme dark:border-D-color-theme text-color-theme dark:text-D-color-theme bql bru flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border-2 font-medium text-[0.875rem]">L</span>
                                        <span className="ads">LLM News</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" className={sidebarLink == "topNews" ? activeClass : nonActiveClass}>
                                        <span className="border-color-theme dark:border-D-color-theme text-color-theme dark:text-D-color-theme bql bru flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border-2 font-medium text-[0.875rem]">T</span>
                                        <span className="ads">Top News</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" className={sidebarLink == "news" ? activeClass : nonActiveClass}>
                                        <span className="border-color-theme dark:border-D-color-theme text-color-theme dark:text-D-color-theme bql bru flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border-2 font-medium text-[0.875rem]">N</span>
                                        <span className="ads">News</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" className={sidebarLink == "coins" ? activeClass : nonActiveClass}>
                                        <span className="border-color-theme dark:border-D-color-theme text-color-theme dark:text-D-color-theme bql bru flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border-2 font-medium text-[0.875rem]">C</span>
                                        <span className="ads">Coins</span>
                                    </a>
                                    <a href="#" className={nonActiveClass}>
                                        <span className="border-color-theme dark:border-D-color-theme text-color-theme dark:text-D-color-theme bql bru flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border-2 font-medium text-[0.875rem]">S</span>
