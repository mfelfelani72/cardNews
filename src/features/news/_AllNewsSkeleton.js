        ...
        <div className="flex flex-row bg-B-V-bright dark:bg-DB-dim text-T-bright dark:text-DT-bright">
            ...
            <div className="w-[99%] lg:w-[73%] 2xl:w-[80%]">
                ...
                <div className="px-3 pt-1 pb-3 border-b border-color-theme-light dark:border-D-color-theme-light">
                    ...
                    <div className="skeleton h-2 w-[100%] my-3"></div>
                    <div className="skeleton h-2 w-[100%] my-3"></div>
                    <div className="skeleton h-2 w-[40%] my-3"></div>
                    <div className='flex flex-row my-4'>
                        <div className="skeleton h-2 w-[15%]"></div>
                        <div className="skeleton h-2 w-[10%] mx-5"></div>
                    </div>
                        ...
                        <div className='flex flex-col mt-2 mx-3'>
                            <div className='basis-1/2 w-full' >
                                <div className='flex flex-wrap'>
                                    ...
                                    <div className="skeleton h-2 w-10 mx-3"></div>
                                </div>
                            </div>
                            <div className='basis-1/2 w-full'>
